...
According to the results, the mean of random_sample is `r mean(pull(my_dataframe, random))`, the mean of logical_vector is `r mean(pull(my_dataframe, logical))`. However, the mean for character_vector and factor_vector returned `r mean(pull(my_dataframe, character))` and `r mean(pull(my_dataframe, factor))`.
